...
import { RequestExercises } from "src/app/components/exercise-editor/exercise-editor.actions";
import { RequestCountdowns } from "src/app/components/countdown/countdown.actions";
...
export class AppComponent {
  ...
  constructor(
    ...
    mIRegiser.addSvgIcon(
      "presets-list",
      domSanitizer.bypassSecurityTrustResourceUrl(
        "assets/images/preset_list.svg",
      ),
    );
    mIRegiser.addSvgIcon(
      "resting-man-green",
      domSanitizer.bypassSecurityTrustResourceUrl(
        "assets/images/resting-man-green.svg",
      ),
    );
    mIRegiser.addSvgIcon(
      "green-flag-black-grip",
      domSanitizer.bypassSecurityTrustResourceUrl(
        "assets/images/green-flag-black-grip.svg",
      ),
    );
    mIRegiser.addSvgIcon(
      "crossed-flag",
      domSanitizer.bypassSecurityTrustResourceUrl(
        "assets/images/crossed-flag.svg",
      ),
    );
    mIRegiser.addSvgIcon(
      "resting-man-green",
    ...
    this.btnAppearanceState$ = store.pipe(
      select(fromRedusers.getMenuBtnAppearance),
    );
    this.btnVisibilityState$ = store.pipe(
      select(fromRedusers.getMenuBtnVisibility),
    );
